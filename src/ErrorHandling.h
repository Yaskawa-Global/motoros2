...
typedef enum
{
    SUBCODE_RCL_RCLC_FAIL_OK,
    SUBCODE_RCL_RCLC_FAIL_ERROR,
    SUBCODE_RCL_RCLC_FAIL_TIMEOUT,
    SUBCODE_RCL_RCLC_FAIL_BAD_ALLOC,
    SUBCODE_RCL_RCLC_FAIL_INVALID_ARGUMENT,
    SUBCODE_RCL_RCLC_FAIL_UNSUPPORTED,

    SUBCODE_RCL_RCLC_FAIL_ALREADY_INIT,
    SUBCODE_RCL_RCLC_FAIL_NOT_INIT,
    SUBCODE_RCL_RCLC_FAIL_MISMATCHED_RMW_ID,
    SUBCODE_RCL_RCLC_FAIL_TOPIC_NAME_INVALID,
    SUBCODE_RCL_RCLC_FAIL_SERVICE_NAME_INVALID,
    SUBCODE_RCL_RCLC_FAIL_UNKNOWN_SUBSTITUTION,
    SUBCODE_RCL_RCLC_FAIL_ALREADY_SHUTDOWN,

    SUBCODE_RCL_RCLC_FAIL_NODE_INVALID,
    SUBCODE_RCL_RCLC_FAIL_NODE_INVALID_NAME,
    SUBCODE_RCL_RCLC_FAIL_NODE_INVALID_NAMESPACE,
    SUBCODE_RCL_RCLC_FAIL_NODE_NAME_NON_EXISTENT,

    SUBCODE_RCL_RCLC_FAIL_PUBLISHER_INVALID,

    SUBCODE_RCL_RCLC_FAIL_SUBSCRIPTION_INVALID,
    SUBCODE_RCL_RCLC_FAIL_SUBSCRIPTION_TAKE_FAILED,

    SUBCODE_RCL_RCLC_FAIL_CLIENT_INVALID,
    SUBCODE_RCL_RCLC_FAIL_CLIENT_TAKE_FAILED,

    SUBCODE_RCL_RCLC_FAIL_SERVICE_INVALID,
    SUBCODE_RCL_RCLC_FAIL_SERVICE_TAKE_FAILED,

    SUBCODE_RCL_RCLC_FAIL_TIMER_INVALID,
    SUBCODE_RCL_RCLC_FAIL_TIMER_CANCELED,

    SUBCODE_RCL_RCLC_FAIL_WAIT_SET_INVALID,
    SUBCODE_RCL_RCLC_FAIL_WAIT_SET_EMPTY,
    SUBCODE_RCL_RCLC_FAIL_WAIT_SET_FULL,

    SUBCODE_RCL_RCLC_FAIL_INVALID_REMAP_RULE,
    SUBCODE_RCL_RCLC_FAIL_WRONG_LEXEME,
    SUBCODE_RCL_RCLC_FAIL_INVALID_ROS_ARGS,
    SUBCODE_RCL_RCLC_FAIL_INVALID_PARAM_RULE,
    SUBCODE_RCL_RCLC_FAIL_INVALID_LOG_LEVEL_RULE,

    SUBCODE_RCL_RCLC_FAIL_EVENT_INVALID,
    SUBCODE_RCL_RCLC_FAIL_EVENT_TAKE_FAILED,

    SUBCODE_RCL_RCLC_FAIL_LIFECYCLE_STATE_REGISTERED,
