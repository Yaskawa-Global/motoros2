...
typedef enum
{
    ...
    SUBCODE_FAIL_CREATE_SERVICE_QUEUE_POINT_STREAM,
    SUBCODE_FAIL_ADD_SERVICE_QUEUE_POINT_STREAM,
    SUBCODE_FAIL_INIT_SERVICE_ABORT_POINT_QUEUE,

    SUBCODE_FAIL_ADD_SERVICE_ABORT_POINT_QUEUE,
