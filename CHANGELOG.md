...
- `motoros2_interfaces` has been updated to version `0.2.0`. Update your client PC's ROS2 workspaces with the instructions [here](https://github.com/yaskawa-global/motoros2_client_interface_dependencies#build-and-installation).
